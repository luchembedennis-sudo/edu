      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl text-blue-900 mb-2">Welcome Back</h2>
            <p className="text-gray-600">Sign in to your EduChat account</p>
          </div>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <Input
                  ...
                  className="pl-10"
                  placeholder="student@mukuba.edu"
                />
              </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-gray-600 text-center">
              <strong>Demo Admin:</strong> admin@mukuba.edu / admin123
            </p>
          </div>
        </div>
      </div>
